...
const OrderCount = ({ count }: Props) => {
  ...
  return (
    <div className="relative h-[120px] 2xs:h-[130px] z-0 w-full max-w-[400px] self-center lg:h-[120px] ">
      ...
      <div className="absolute left-[6%] top-0  z-10 flex h-full w-[88%] items-end justify-center rounded-[16px] bg-white pb-[10px] text-[30px] font-bold text-primary-blue shadow-[0px_0px_12px_4px_rgb(0,0,0,0.15)]">
        {count}
      </div>
