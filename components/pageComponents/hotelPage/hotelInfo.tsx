...
const HotelInfo = ({
  ...
  return (
    <div className="flex flex-col gap-[16px] lg:gap-[24px]">
      ...
      {/* review & stat */}
      <div
        className={` relative flex w-full flex-wrap justify-start items-center gap-[12px] pr-[8px] text-[16px] font-medium text-white lg:hidden`}
      >
        {/* stat */}
        <div
          className={`${
        ...
        {stat !== "data" && (
          <div className="flex items-center gap-[8px] text-[18px] tracking-wider text-primary-blue">
            <div className="flex h-[28px] w-[28px] items-center justify-center rounded-full bg-primary-blue text-white">
              <svg
                viewBox="0 2 24 24"
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
