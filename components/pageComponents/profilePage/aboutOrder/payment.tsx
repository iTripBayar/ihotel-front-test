          ...
          <div className="hidden gap-[12px] w-full pt-[16px] text-[16px] md:pt-0 m-auto md:flex md:flex-row md:max-w-[450px] justify-center items-center leading-[15px] ">
            ...
            <button
              ...
              onClick={() => {
                toast.custom(
                  (t) => (
                    <div className="w-full min-w-[360px] flex flex-col gap-[24px] bg-white border font-medium border-black/[.25] rounded-[20px] px-[16px] py-[12px] items-center">
                      <button
