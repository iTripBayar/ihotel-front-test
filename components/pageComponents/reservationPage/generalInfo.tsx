...
export default function GeneralInfo({
  ...
  return (
    <div className="lg:flex hidden w-full flex-col gap-[10px]">
      {/* <h3 className="text-[20px] leading-[22px] font-medium text-main-text text-center lg:hidden">
        {lang === "en" ? nameEn : name}
      </h3> */}
      <p className="text-[18px] font-medium leading-[18px] text-sub-text lg:hidden">
        {lang === "en" ? "Order information" : "Захиалгийн мэдээлэл"}
      </p>
      <div className="flex w-full flex-col gap-[24px] lg:flex-col ">
        ...
        {size.width && size.width < 1024 ? (
          ...
          // <div
          //   className="flex h-auto w-full flex-col gap-[12px] items-center"
          // >
          ...
          <div className="lg:grid lg:grid-cols-5 lg:gap-[24px]">
            ...
            <div className="col-span-2 flex h-full w-full flex-col justify-between">
              <div className="flex flex-col gap-[12px]">
                <h3 className="text-[20px] leading-[22px] font-medium text-main-text text-center lg:text-start">
                  {lang === "en" ? nameEn : name}
                </h3>
        ...
        {/* calendar */}
        {checkIn && checkOut ? (
          <div className="lg:flex w-full flex-col gap-[24px] items-center hidden">
            <div
              // className="flex w-full items-center justify-between gap-[20px] rounded-[20px] bg-white px-[16px] py-[12px] shadow-[0px_0px_12px_2px_rgb(0,0,0,0.15)] 2xs:gap-[36px] lg:col-span-4 lg:px-0 lg:shadow-none"
              className="flex w-full items-center justify-between gap-[20px] max-w-[300px] lg:max-w-[350px] rounded-[20px] bg-white 2xs:gap-[36px] lg:col-span-4 lg:px-0 lg:shadow-none"
            >
              {/* checkIn */}
            ...
            {/* <button
              className="relative flex min-h-[42px] w-full items-center justify-center rounded-full text-primary-blue px-[20px] text-[16px] font-medium border border-primary-blue sm:min-h-[46px] sm:text-[18px] lg:col-span-2 lg:min-h-[20px] lg:max-w-[165px] lg:justify-between lg:justify-self-end lg:px-[16px] lg:py-[12px] lg:text-[15px] lg:leading-[14px]"
              onClick={() => {
                dispatch({
