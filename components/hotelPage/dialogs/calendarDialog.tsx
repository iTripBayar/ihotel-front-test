...
const multipleCreateQueryString = useCallback(
  ...
  return (
    <div className="relative flex  h-[90vh] w-full flex-col items-center justify-start pt-[24px] rounded-t-[30px] bg-white shadow-[0px_0px_12px_2px_rgb(0,0,0,0.25)] sm:px-[32px]">
      <div
      ...
      />
      <div className="flex max-w-[150px] items-center justify-center rounded-full bg-primary-blue px-[16px] py-[10px] text-[14px] font-medium uppercase text-white"
      onClick={()=>{
