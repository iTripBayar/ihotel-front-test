        ...
        >
          ...
          <div className="flex overflow-hidden w-full items-center gap-[10px] font-medium pr-[14px] text-[14px] leading-[16px]">
            ...
            <div className="flex gap-[4px] text-primary-blue text-[16px] ">
              ...
              >
                <path
                  d="M20.2702 16.265L20.9752 12.185C21.0166 11.9459 21.0052 11.7006 20.9419 11.4663C20.8786 11.232 20.7648 11.0144 20.6086 10.8287C20.4524 10.643 20.2575 10.4936
                   20.0375 10.391C19.8176 10.2885 19.5779 10.2352 19.3352 10.235H14.1542C14.0333 10.235 13.9138 10.2087 13.8041 10.1579C13.6944 10.1071 13.597 10.0331 13.5188
                    9.94087C13.4406 9.84867 13.3834 9.74054 13.3511 9.624C13.3189 9.50746 13.3125 9.3853 13.3322 9.26601L13.9952 5.22101C14.1028 4.56424 14.0721 3.89225 13.9052
                     3.24801C13.8338 2.98181 13.6962 2.73799 13.5053 2.5392C13.3144 2.34042 13.0763 2.19313 12.8132 2.11101L12.6682 2.06401C12.3404 1.9587 11.9846 1.98303 11.6742
                      2.13201C11.3342 2.29601 11.0862 2.59501 10.9942 2.95001L10.5182 4.78401C10.3667 5.36764 10.1465 5.93124 9.8622 6.46301C9.4472 7.24001 8.8052 7.86301 8.1372
                       8.43801L6.6982 9.67801C6.49857 9.85052 6.34266 10.0679 6.24323 10.3123C6.14381 10.5567 6.1037 10.8211 6.1262 11.084L6.9382 20.477C6.97399 20.8924 7.16424
                        21.2793 7.47139 21.5613C7.77854 21.8432 8.18025 21.9998 8.5972 22H13.2452C16.7272 22 19.6982 19.574 20.2702 16.265Z"
                  fill="currentColor"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M2.96808 9.485C3.16134 9.47655 3.35039 9.5431 3.49574 9.67075C3.64109 9.7984 3.7315 9.97727 3.74808 10.17L4.71808 21.406C4.73451 21.5733 4.71666 21.7422 4.66562
                   21.9024C4.61458 22.0626 4.53142 22.2107 4.42122 22.3377C4.31102 22.4647 4.17609 22.5678 4.02468 22.6409C3.87327 22.714 3.70855 22.7555 3.54058 22.7627C3.37261
                    22.77 3.20492 22.743 3.04775 22.6833C2.89058 22.6236 2.74723 22.5325 2.62646 22.4155C2.50568 22.2986 2.41002 22.1582 2.3453 22.003C2.28059 21.8479 2.24819 21.6811
                     2.25008 21.513V10.234C2.25016 10.0407 2.32488 9.85486 2.45866 9.71531C2.59244 9.57576 2.77494 9.49325 2.96808 9.485Z"
                  fill="currentColor"
                />
              </svg>
              <p>
                {data.rating}
                <span className="text-[12px] leading-[14px] text-sub-text/75 font-[500]">
                  {" "}
                  / 10
                </span>
              </p>
            ...
            {/* address */}
            <div className="text-primary-blue flex gap-[4px] ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="2 2 22 22"
                fill="currentColor"
              ...
              <p className="text-sub-text/75 font-[400]">
                {lang === "en"
                  ? `${
